...
stage('Preparation') {
  ...
  sh 'chmod 777 ./kubectl && mv kubectl /usr/local/sbin'
//Clone git repository
  git url:'https://github.com/CGaidhane/k8s-node-js-poc.git'
   }
stage('Integration') {
 
      withKubeConfig([credentialsId: 'jenkins-deployer-credentials', serverUrl: 'https://18.195.19.14']) {
